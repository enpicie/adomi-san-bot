...
variable "scheduled_job_layer_s3_key" {
  description = "S3 key for .zip of Lambda layer built for scheduled_job"
  type        = string
}

variable "scheduled_job_layer_hash_s3_key" {
  description = "S3 key for .hash file for Lambda layer built for scheduled_job"
  type        = string
}
